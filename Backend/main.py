...
# ── WINDOWS FIX ───────────────────────────────────────────────────────
# SelectorEventLoop (Windows default) cannot create subprocesses.
# Playwright uses subprocess internally — ProactorEventLoop is required.
...
if __name__ == "__main__":
    import uvicorn
    # DO NOT use --reload on Windows with Playwright
    # --reload uses a WatchFiles subprocess that resets the event loop policy
